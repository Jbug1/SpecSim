...
def generate_keep_indices(noise_threshes, centroid_tolerance_vals, powers, spec_features, sim_methods, prec_removes =[True],any_=False, nonspecs=False, init_spec=False):
